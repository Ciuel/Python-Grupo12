...
def build():
    layout= [
        ...
        [sg.Text("Cant Coincidencias: ", size=SIZE,justification="left"), 
         sg.Combo(['2', '3', '4'],key="-CHOOSE COINCIDENCES-", enable_events="true",size=(5,1),readonly="true"),
         ...
         [sg.Text("Dificultad",size=(8,1)),sg.Combo(['Facil', 'Medio', 'Dificil','Muy Dificil'],key="-CHOOSE DIFFICULTY-", enable_events="true",pad=SEPARACION,readonly="true"),
