...
def build():
    ...
    layout_registro = [
        ...
        [sg.Text("Confirmar contraseña", size=(8,2)),sg.InputText(key="-REGIS CONFIRM PASSWORD-", enable_events="true"),sg.Text("", size=SIZE, key="-CONFIRMATION TEXT-")],
    ...
    login_window = sg.Window("Login MemPy",layout,finalize="true",size=(800, 600),element_justification='center')
