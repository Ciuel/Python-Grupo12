...
from ..Constants.constants import WINDOW_FONT_SIZE, ELEMENT_SIZE, WINDOW_TITLE_FONT, WINDOW_DEFAULT_THEME
...
def build()->sg.Window:
    ...
    layout_login = [#Fonts:Caladea
        [sg.Text("MemPy",font=(WINDOW_TITLE_FONT, WINDOW_FONT_SIZE *3),pad=(None,(15,30)),justification="center")],
        ...
        [sg.Text("",pad=((0,180),None),size=(30,1), key="-W_LOGIN TEXT-",text_color="red")],
        [sg.Text("No tiene sesion, Registrarse",pad=((0,300),None),enable_events=True,text_color="blue", key="-REGIS-"),
    ...
    layout_registro = [
        [sg.Text("Registro",font=(WINDOW_TITLE_FONT, WINDOW_FONT_SIZE *2),pad=(None,(0,30)),justification="center")],
